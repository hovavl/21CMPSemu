...
nwalkers = 24
niter = 10000
initial = np.array([-1.24,-2.0, 0.5, 0, -1.35, -2, 0.3, 40.0, 0.72])  # best guesses
ndim = len(initial)
...
pickle.dump(flat_samples, open(f'/gpfs0/elyk/users/hovavl/jobs/21cm_mcmc_job/MCMC_results_mini/high_prior_MCMC_results_{datetime.date.today()}_with_hera_updated_mini_no_Mturn.pk', 'wb'))
...
plt.savefig(f'/gpfs0/elyk/users/hovavl/jobs/21cm_mcmc_job/MCMC_results_mini/high_prior_with_hera_mini_{datetime.date.today()}_no_Mturn.png')
