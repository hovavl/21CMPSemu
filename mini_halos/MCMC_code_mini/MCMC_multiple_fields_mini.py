...
nwalkers = 24
niter = 10000
initial = np.array([-1.24,-2, 0.5, 0, -1.35, -1.5, 0.3, 40.0, 0.72])  # best guesses
ndim = len(initial)
...
pickle.dump(flat_samples, open(f'/gpfs0/elyk/users/hovavl/jobs/21cm_mcmc_job/MCMC_results_mini/MCMC_{datetime.date.today()}_large_fesc7_all_fields.pk', 'wb'))
...
plt.savefig(f'/gpfs0/elyk/users/hovavl/jobs/21cm_mcmc_job/MCMC_results_mini/MCMC_{datetime.date.today()}_large_fesc7_all_fields.png')
