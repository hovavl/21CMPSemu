...
pickle.dump(flat_samples, open(f'/gpfs0/elyk/users/hovavl/jobs/21cm_mcmc_job/MCMC_results_mini/MCMC_results_{datetime.date.today()}_no_hera_updated_mini_no_Mturn.pk', 'wb'))
...
plt.savefig(f'/gpfs0/elyk/users/hovavl/jobs/21cm_mcmc_job/MCMC_results_mini/no_hera_mini_{datetime.date.today()}_no_Mturn.png')
